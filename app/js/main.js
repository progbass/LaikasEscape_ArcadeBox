...
define(['jquery', 'underscore', 'backbone', 'Game', 'fastclick', 'io'], function($, _, Backbone, Game) {
	...
	var setupCanvasResolution = function(){
		var maxWidth = 1024;
		
		//get actual window dimensions
		var contextWidth = (window.innerWidth < maxWidth) ? window.innerWidth : maxWidth;
		var contextHeight = window.innerHeight;
		var width, height;
		
		
		//calculate actual window ratio
		var actualRatio = contextWidth / contextHeight;
		var ratio = actualRatio;
			
			
		if(!window.mobileAndTabletcheck()){
			
			//console.log(ratio+"	:	"+refRatio)
