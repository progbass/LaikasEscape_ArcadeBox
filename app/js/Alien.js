...
define(['easel', 'tween', 'sound', 'preload'], function(){
	...
	var Alien = Backbone.View.extend({
		...
		enemies_config: [
			{
				src: 'img/alien1.png',
				positions: [{x: 220, y: 335}, {x: 568, y: 345}, {x: 912, y: 335}, {x: 290, y: 480}, {x: 720, y: 540}, {x: 1040, y: 485},],
			...
			{
				src: 'img/alien2.png',
				positions: [{x: 222, y: 310}, {x: 570, y: 360}, {x: 915, y: 320}, {x: 285, y: 465}, {x: 735, y: 530}, {x: 1035, y: 468}],
		...
		initialize: function(){
			...
			//bind scope
			_.bindAll(this, 'enemyHit', 'render', 'removeEnemy', 'hide', 'setHole', 'close' );
			...
			//events
			this.sprite.on('click', this.enemyHit, this);
